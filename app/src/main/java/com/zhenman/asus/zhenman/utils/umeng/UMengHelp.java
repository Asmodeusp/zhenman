...
//            if ("女".equals(gender)){
////                    男1 女2
//                SPUtils.put(context, SPKey.UMeng_SEX,"2");
//            }else {
//                SPUtils.put(context, SPKey.UMeng_SEX,"1");
//            }
////                成功的话保存到sp中
//            SPUtils.put(context, SPKey.UMeng_CITYNAME,data.get("city"));
//            SPUtils.put(context, SPKey.UMeng_NAME,data.get("name"));
//            SPUtils.put(context, SPKey.UMeng_HEADIMAGE,data.get("iconurl"));
//            SPUtils.put(context, SPKey.UMeng_OPENID,data.get("openid"));
//            SPUtils.put(context, SPKey.UMeng_OTHERUSERId,data.get("unionid"));
//            SPUtils.put(context, SPKey.UMENG_TYPE,TYPE);
