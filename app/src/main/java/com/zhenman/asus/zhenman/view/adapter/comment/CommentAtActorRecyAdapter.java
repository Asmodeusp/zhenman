...
public class CommentAtActorRecyAdapter extends RecyclerView.Adapter<CommentAtActorRecyAdapter.Holder> implements View.OnClickListener {
    ...
    public void onBindViewHolder(@NonNull final Holder holder, int position) {
        ...
        holder.Comment_At_Item_headImage_title_decription.setText(listBean.getTagName());
        holder.itemView.setTag(position);

        GlideUtils.loadCircleImage(listBean.getHeadImg(), holder.Comment_At_Item_headImage, new GlideUtils.ImageLoadListener<String, GlideDrawable>() {
            @Override
