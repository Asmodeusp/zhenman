...
public class RoundImageViewUtils extends ImageView {
    //圆角大小，默认为10
    ...
    public RoundImageViewUtils(Context context) {
        this(context, null);
    }

    public RoundImageViewUtils(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundImageViewUtils(Context context, AttributeSet attrs, int defStyleAttr) {
