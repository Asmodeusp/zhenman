...
public class CatalogReadPopuCommentAdapter extends RecyclerView.Adapter<CatalogReadPopuCommentAdapter.Holder> implements View.OnClickListener {
    ...
    public CatalogReadPopuCommentAdapter(List<SerializationDetailsBean.DataBean.ActorListBean> list) {
        this.list = list;
    }
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View inflate = LayoutInflater.from(context).inflate(R.layout.fill_catalogreadpopucomment_adapter, parent, false);
